...
MidiBus myBus1; // Bus - melodi //violet hurtigere? 
MidiBus myBus2; // The MidiBus - syke ting? //rød vet ikke  
MidiBus myBus3; // Bus - bass //pink 
...
int channel = 2; // ? 
int pitch = 1; //hvorfor 2 og ikke 0 ? // hvilke tangent som spilles
...
void draw() {
  ...
  if (nextTimeNodeMillis < millis()) {
    ...
    int tempo = 118; //beats per minute //house :)
    int nodeFractions[] = {8, 8, 8, 4, 4, 2};
